...
-- Create a policy that allows only authenticated users to view waitlist entries
...
-- Create a policy that allows only authenticated users to insert new waitlist entries
...
COMMENT ON TABLE waitlist IS 'Waitlist entries for FreelanceShield';
