...
declare_id!("BcZfN4TJYzWZsNXpLFjgEiZSqV124W2uJPEgFHdsp9TD");
...
pub const RISK_POOL_PROGRAM_ID: Pubkey = anchor_lang::solana_program::pubkey!("AGNZSGGL9hdWfT76TVFypbPcfsbrRJLDcHmczghbixoM");
